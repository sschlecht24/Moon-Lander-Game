...
function drawTitle(){
  ...
  context.fillText( "Syon's Lander", canvas.width / 2 , 50);
}
...
function drawInstructions(){
  ...
  context.textAlign = 'center'
  context.fillText( "Land on the green pad!", canvas.width / 2 , 150);
  context.fillText( "Use the up arrow for thrust, left and right arrows to maneuver.", canvas.width / 2 , 180);
...
function drawPortfolio(){
  ...
  // context.fillText( "work!", canvas.width - 5, 670);
  context.fillText( "Check out my work ---> ", canvas.width, 690);
}
...
function drawLanding(){
  ...
  context.fillStyle = 'green';
  context.textAlign = 'center'
  context.fillText( "You did it!", canvas.width / 2 , 300);
  drawMessage();
  drawRestart();
}
